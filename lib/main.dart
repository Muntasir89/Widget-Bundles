...
import 'package:all_widget/Widgets/Getx.dart';

import 'Widgets/Animations.dart';
import 'Widgets/ExpansionTilePage.dart';
import 'Widgets/Provider/ProviderClass.dart';
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Container(
                                ...
                                height: 58,
                                child: Center(
                                  child: Text(items[index].index.toString(),
                                      style: TextStyle(
                                          fontSize: 30,
  ...
  void ChooseRoute(BuildContext context, String string) {
    if (string == "WidgetClusters") {
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => WrapWidget(title: string)));
    } else if (string == "Time Picker") {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => TimePicker(title: string)));
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => GridPaperWidget()));
    ...
    } else if (string == "Provider") {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => ProviderClass()));
    } else if (string == "Getx") {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => GetxApp()));
    }
  }
}
